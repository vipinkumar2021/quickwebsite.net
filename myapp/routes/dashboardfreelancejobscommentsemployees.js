var express = require('express');
  ...
  router.post('/', function(req, res, next) {
    ...
    if(currentLoginUser) {
      ...
      var freelanceJobsCommentsDetails = new freelanceJobsCommentsModel({
        ...
        RequestPayment: req.body.requestpayment          
      });
  ...
  ses.sendEmail(params, (err) => {
    if(err) {
      ...
      res.render('dashboardemployees', { title: 'Quick Website', msg:'Commented Successfully! Please wait for Reply', loginUser: currentLoginUser}); 
    }
  });
  //
