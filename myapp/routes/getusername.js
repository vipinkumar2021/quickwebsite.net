...
let params = {
  ...
  ses.sendEmail(params, (err) => {
    if(err) {
      res.render('getusername', { title: 'frontendwebdeveloper', msg:'Error Occured, Email Sending failed'}); 
    } else {
  ...
  ses.sendEmail(params, (err) => {
    if(err) {
      res.render('getusername', { title: 'frontendwebdeveloper', msg:'Error Occured, Email Sending failed'}); 
        ...
        //res.render('/', { title: 'frontendwebdeveloper', msg:'Your Username has been sent to your Email Id' });
