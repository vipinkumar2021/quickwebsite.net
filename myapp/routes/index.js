...
router.post('/create-checkout-session', async (req, res) => { 
  ...
  const YOUR_DOMAIN = 'https://www.quickwebsite.net/';//'http://localhost:5000/'///'http://www.quickwebsite.net/';//'http://localhost:5000/'// 'http://www.quickwebsite.net/'; // 'http://localhost:5000'
