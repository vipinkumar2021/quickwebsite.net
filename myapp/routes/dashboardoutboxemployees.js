...
router.get('/', function(req, res, next) {
  ...
  if(currentLoginUser) {
    ...
    freelanceJobsComments.exec((err, freelanceJobsCommentsData)=> {
      if(err) {
        res.render('dashboardoutboxemployees', { title: 'Quick Website', msg: '', loginUser: currentLoginUser, freelanceJobsCommentsData: '' });
      } else {
        res.render('dashboardoutboxemployees', { title: 'Quick Website', msg: '', loginUser: currentLoginUser, freelanceJobsCommentsData: freelanceJobsCommentsData  });
      }
    });
    //
