...
router.get('/', function(req, res, next) {
  ...
  if(currentLoginUser) {
    ...
    res.render('dashboardpostaddemployees', { title: 'Quick Website', msg: '', loginUser: currentLoginUser });
...
ses.sendEmail(params, (err) => {
  if(err) {
    res.render('dashboardpostaddemployees', { title: 'Quick Website', msg: 'Advertisement Posted Successfully!', loginUser: currentLoginUser});
  } else {
    res.render('dashboardpostaddemployees', { title: 'Quick Website', msg: 'Advertisement Posted Successfully!', loginUser: currentLoginUser});
  }
});
